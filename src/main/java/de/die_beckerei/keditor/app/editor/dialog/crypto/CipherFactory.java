...
import de.die_beckerei.keditor.app.editor.dialog.crypto.cipher.AES;
import de.die_beckerei.keditor.app.editor.dialog.crypto.cipher.Cipher;
import de.die_beckerei.keditor.app.editor.dialog.crypto.cipher.DES;
import de.die_beckerei.keditor.app.editor.dialog.crypto.cipher.types.AES_NoPadding_ECB;
import de.die_beckerei.keditor.app.editor.dialog.crypto.cipher.types.AlgoDES;
import de.die_beckerei.keditor.app.editor.dialog.crypto.cipher.types.Algorithm;
import de.die_beckerei.keditor.app.editor.dialog.crypto.cipher.types.AES_PKCS7_ECB;
